...
all.markers$gene %in% rownames(bulk.es.exp)
...
bulk.es.short <- bulk.es.exp[all.markers$gene,] |>
                 as.data.frame() |>
                 sapply(as.integer)
  

  decon <- music_prop(bulk.mtx = bulk.es.short, sc.sce = sn.sce, markers = all.markers$gene,
