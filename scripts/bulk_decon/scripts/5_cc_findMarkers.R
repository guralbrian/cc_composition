...
bulk.all <- read.csv("data/processed/bulk/cc_and_fractions.csv", row.names = 1)
...
# Save the data
write.csv(all.markers, "data/processed/single_cell/cc_cluster_markers.csv", row.names = F)
